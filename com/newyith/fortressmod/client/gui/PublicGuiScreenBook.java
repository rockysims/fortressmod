...
public class PublicGuiScreenBook extends GuiScreen
{
    ...
    private PublicGuiScreenBook.NextPageButton buttonNextPage;
    private PublicGuiScreenBook.NextPageButton buttonPreviousPage;
    ...
    public PublicGuiScreenBook(EntityPlayer p_i1080_1_, ItemStack p_i1080_2_, boolean p_i1080_3_)
    {
    ...
    public void initGui()
    {
        ...
        byte b0 = 2;
        this.buttonList.add(this.buttonNextPage = new PublicGuiScreenBook.NextPageButton(1, i + 120, b0 + 154, true));
        this.buttonList.add(this.buttonPreviousPage = new PublicGuiScreenBook.NextPageButton(2, i + 38, b0 + 154, false));
        this.updateButtons();
    }
    ...
    static class NextPageButton extends GuiButton
        {
            ...
            public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
            {
                if (this.visible)
                {
                    ...
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                    p_146112_1_.getTextureManager().bindTexture(PublicGuiScreenBook.bookGuiTextures);
                    int k = 0;
                    int l = 192;
